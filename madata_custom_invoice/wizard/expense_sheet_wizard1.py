...
class ExpenseSheetWizard(models.TransientModel):
    ...
    def report_expense_fonc(self):
        ...
        # return self.env.ref('madata_custom_invoice.report_hr_expense_wizard').report_action(self)
        return self.env.ref('madata_custom_invoice.report_hr_expense_wizard').report_action(self, data=data_db)
